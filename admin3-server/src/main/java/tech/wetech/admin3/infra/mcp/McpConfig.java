package tech.wetech.admin3.infra.mcp;
...
public class McpConfig {
  ...
  @Bean
  RouterFunction<ServerResponse> mcpRouterFunction(@Qualifier("webMvcStatelessServerTransport") WebMvcStatelessServerTransport transport) {
    return transport.getRouterFunction();
  }

  @Bean
  McpStatelessSyncServer mcpStatelessSyncServer(@Qualifier("webMvcStatelessServerTransport") WebMvcStatelessServerTransport transport, LeaveService leaveService, @Qualifier("mcpJsonMapper") McpJsonMapper jsonMapper) {
    return McpServer.sync(transport)
      .serverInfo("leave-mcp-server", "1.0.0")
